...
<body class="nav-md">
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Habitaciones <small>registro de habitaciones que dispone el hotel</small></h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>RioHotel <small>Habitaciones</small>
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-AdminHabitacion"> Agregar Habitación </button>
                                    </h2>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card-box table-responsive">
                                                <table id="tblAdminHabitacion" class="table table-striped table-bordered" style="width:100%">
                                                    <thead>
                                                        <tr>
                    ...
                    <div class="modal fade" id="modal-AdminHabitacion">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Número:</label>
                                        <input type="number" id="txtAAHNumero" class="form-control" placeholder="Número de habitación">
                                    </div>

                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Costo:</label>
                                        <input type="number" id="txtAAHCosto" class="form-control" placeholder="Costo de habitación">
                                    </div>

                                    <div class="col-md-6 col-sm-6 ">
                                        <label style="margin-top: 15px;">Tipo Habitación</label>
                                        <select id="cmdAAHTipo" class="form-control"> </select>
                                    </div>

                                    <div class="col-md-6 col-sm-6 ">
                                        <label style="margin-top: 15px;">Estado Habitación</label>
                                        <select id="cmdAAHEstado" class="form-control"> </select>
                                    </div>
                                    <label style="margin-top: 15px;">Capacidad:</label>
                                    <input type="number" id="txtAAHCapacidad" class="form-control" placeholder="Capacidad de la habitación">

                                    <label style="margin-top: 15px;">Detalle:</label>
                                    <textarea class="form-control" id="txtAAHDetalle" rows="3" placeholder="Ingrese la descripción de la habitación"></textarea>

                                    <img src="" id="imgAAHFoto" style="width: 75px; height:75px; margin-top: 10px;">
                                    <input type='file' style='margin-top: 6px;' multiple accept='image/png, .jpeg, .jpg, image/gif' maxlength='1000000' id='filAAHabitacion'>

                                </div>
                                <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <button type="button" class="btn btn-primary" onclick="ingresoAdHabitacion()">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(function() {
            verAdminDataHotel(2, 1, 'cmdAAHTipo');
            verAdminDataHotel(3, 1, 'cmdAAHEstado');
            verAdminDataHotel(4, 2, 'tbodyAAHabitacion');
        });

        $("#filAAHabitacion").change(function() {
            getArchivoBase64('filAAHabitacion', 'imgAAHFoto');
        });

        function ingresoAdHabitacion() {
            guardarFormDataHotel(3, $('#txtAAHNumero').val(), $('#txtAAHCosto').val(), $('#txtAAHDetalle').val(), $('#txtAAHCapacidad').val(), $('#cmdAAHTipo').val(),
                $('#cmdAAHEstado').val(), formato64, 'na', 'na', 'na', 'na', 'na', 'na', 'na', 'na', 'na', 'na');
        }
    </script>
</body>

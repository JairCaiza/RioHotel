...
<body class="nav-md">
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Estado de Habitaciones <small>registro de estado de habitaciones </small></h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>RioHotel <small>estado de Habitaciones</small>
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-ReservaHabitacion"> Nuevo estado </button>
                                    </h2>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card-box table-responsive">
                                                <table id="tblAdminEstadoHabitacion" class="table table-striped table-bordered" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody id="tbodyAAEstadoHabitacion">
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
                    ...
                    <div class="modal fade" id="modal-ReservaHabitacion">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Registro de estado de Habitación</h4>
                                ...
                                <div class="modal-body">
                                    ...
                                    <textarea class="form-control" id="txtAAEHDetalle" rows="3" placeholder="Ingrese la descripción del estado"></textarea>

                                    <label style="margin-top: 15px;">Estado</label>
                                    <select id="cmdAAEstadoHEstado" class="form-control">
                                ...
                                <div class="modal-footer justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="ingresoAdEstadoHabitacion()">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function ingresoAdEstadoHabitacion() {
            guardarFormDataHotel(5, $('#txtAAEHDetalle').val(), $('#cmdAAEstadoHEstado').val(), 'na', 'na', 'na', 'na', 'na', 'na', 'na', 'na',
